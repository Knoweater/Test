...
//        posX, posY, width, height, NULL, hMenu, GetModuleHandle(NULL), NULL);
//}
//
...
//    }
//    case WM_KEYDOWN: {
//        // Переміщення вікна за допомогою клавіш WASD
//        RECT rect;
...
//    // Створення вікна
//    Window myWindow(800, 600, 100, 100, 10, RGB(0, 0, 0), L"Лабораторне вікно", RGB(255, 255, 255));
//
//    // Показати вікно
